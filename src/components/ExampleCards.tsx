...
const examples: ExampleCard[] = [
  ...
  },
  {
    ...
    prompt: 'Generate a serene mountain landscape with a village in Ghibli style',
    realPrompt: 'Generate a serene mountain landscape with a village in Ghibli style',
    styleId: 'ghibli',
  },
];

...
export function useChatHandlers({
  ...
  }, [input, sendMessage, uploadState, styleState, handleRemoveUpload, handleStyleRemove, setInput]);

  const handleExampleSelect = useCallback((prompt: string, imageUrl?: string, styleId?: string) => {
